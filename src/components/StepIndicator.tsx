      ...
      <div className="flex items-center justify-center gap-0">
        {steps.map((step, idx) => (
          <div key={step.n} className="flex items-center">
            ...
            >
              <div className={`relative w-8 h-8 rounded-full border font-mono text-[12px] font-bold flex items-center justify-center transition-all duration-300 ${
            ...
            {idx < steps.length - 1 && (
              <div className="w-12 md:w-16 h-px bg-[#1e2530] mx-4 shrink-0 relative overflow-hidden">
                <motion.div
